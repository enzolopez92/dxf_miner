...
def main():
   dwg = ezdxf.readfile('/Users/elcaballero/Downloads/CP-JRL-ET-L19-DR-S-43-2106-P01.dxf')
...
#######################################################################################
################## Importing all the comments inside the drawing layer #############
########################################################################################
# import sys
# sys.path.append('/opt/homebrew/lib/python3.11/site-packages')
# import ezdxf
